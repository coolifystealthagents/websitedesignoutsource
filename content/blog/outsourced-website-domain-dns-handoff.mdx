...
## Map every service behind the domain
...
## Keep authority with the company
...
## Check more than the website address
...
## Distinguish a defect from propagation
...
## Pre-authorize rollback conditions
...
## Review the exact record changes
...
## Return access and records cleanly
...
## The handoff is complete when ownership is clear
