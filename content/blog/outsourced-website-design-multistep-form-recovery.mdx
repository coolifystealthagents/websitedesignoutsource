---
title: "Plan Recovery States for a Multistep Website Form"
description: "Specify save, validation, timeout, back-button, and submission recovery behavior before an outsourced team builds a long website form."
slug: "outsourced-website-design-multistep-form-recovery"
...
- Map every point where progress can be interrupted.
- State which non-sensitive values may be retained and for how long.
- Write field-level and step-level error behavior.
- Define a safe response to duplicate submission attempts.
- Test refresh, back navigation, timeout, and failed network requests.
