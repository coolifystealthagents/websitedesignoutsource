...
## Rules for the next editorial handoff

- Add one contextual link only where it answers the reader's next practical question.
- Keep the reader on the article when the service page would be a generic detour.
- State that the company owner approves scope, access, and exceptions.
- Keep service, article, schema, and sitemap dates in step when a public page changes.
- Do not reuse a source-to-target pair once it is live.

## Existing service pillars and supporting evidence routes
